...
def test__clean_numbers_out_of_range(paginator: PaginationGenerator, total_pages, list_to_clean, result_to_assert):
...
def test__get_indexes_to_be_fold(paginator: PaginationGenerator, list_to_parse, indexes_to_be_fold):
